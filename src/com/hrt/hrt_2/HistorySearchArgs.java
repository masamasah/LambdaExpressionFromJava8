...
public class HistorySearchArgs {
    ...
    public static void main(String[] args){
        ...
        Consumer<HistoryPerson> resultYear = (p) -> System.out.println(p.getName()+"さんは"+
                (NAGASHINO-p.getBornYear()) + "歳");

        Consumer<HistoryPerson> resultCastle = (p) -> System.out.println(p.getName()+"さんのお住いの"+p.getCastleName());

        System.out.println("1575年の時点で");
        search(people, isBorn.and(notDead), resultYear);

        System.out.println("富士山から東にあったのは");
